...
CHUNK_SIZE = 1000
CHUNK_OVERLAP = 200
PDF_PATH = "data/pdfs/prospectus.pdf"
TEXT_PATH = "data/texts/prospectus.txt"
...
def main():
    try:
        ...
        sample_queries = [
            {"query": "মোট কতগুলি বিভাগ রয়েছে?", "expected": "১৬ টি"},
            {"query": "মোট কতগুলি আসন রয়েছে?", "expected": "১০৬৫ টি"},
            {"query": "কত নম্বরের পরীক্ষা নেওয়া হবে?", "expected": "৫০০ নম্বর"}
        ]
